...
longer_prompts = [
    {'name': 'Finger Strings',
     'directions': ['Hold your hand out in front of you', 'Do this horizontally with palm facing down. Now open your mind and give your unconscious mind a judgement-free space to speak.',
    ...
    {'name': 'Least & Most',
     ...
     'Person I lease want to see right now.', 'Now that you know the format, do the same thing with a second name. But this time with the person (or non-person) you LEASE want to see.',
